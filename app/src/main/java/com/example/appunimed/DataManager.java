...
public class DataManager {
    ...
    public static ArrayList<Especialidad> getEspecialidades() {
        ...
        listaEspecialidades.add(new Especialidad("Cardiología", doctoresCardiologia, R.drawable.cardiology));
        ...
        listaEspecialidades.add(new Especialidad("Pediatría", doctoresPediatria,R.drawable.pediatry));
        ...
        listaEspecialidades.add(new Especialidad("Ginecología", doctoresGinecologia,R.drawable.female));
        ...
        listaEspecialidades.add(new Especialidad("Dermatología", doctoresDermatologia,R.drawable.dermathology));
        ...
        listaEspecialidades.add(new Especialidad("Neumología", doctoresNeumologia,R.drawable.tuberculosis));
